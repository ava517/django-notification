...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'NoticeType.is_visible'
        db.add_column(u'notification_noticetype', 'is_visible',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'NoticeType.is_visible'
        db.delete_column(u'notification_noticetype', 'is_visible')
